...
#             df = csv.DictReader(csvFile, fieldnames)
#             logging.debug('Un-Cleaned Data CSV read Successfully!')
#             print(df)
#             # df['messageId'] = DataCleaner.get_field("Message-ID", df['message'])
#             # df['date'] = DataCleaner.get_field("Date", df['message'])
#             # df['subject'] = DataCleaner.get_field("Subject", df['message'])
#             # df['from'] = DataCleaner.get_field("X-From", df['message'])
#             # df['to'] = DataCleaner.get_field("X-To", df['message'])
#             # df['cc'] = DataCleaner.get_field("X-cc", df['message'])
#             # df['bcc'] = DataCleaner.get_field("X-bcc", df['message'])
#             # df['mimeVersion'] = DataCleaner.get_field("Mime-Version", df['message'])
#             # df['contentType'] = DataCleaner.get_field("Content-Type", df['message'])
#             # df['text'] = DataCleaner.get_body(df['message'])
