...
class DataUploader:
    ...
    def create_solr_connection(self, solr_zookeeper_string, solr_collection_name):
    ...
    def push_data_into_solr(self, solrObject, datasetPath):
        maxInt = sys.maxsize
        while True:
            try:
    ...
    def index_data(self, dataHandler):
        try:
